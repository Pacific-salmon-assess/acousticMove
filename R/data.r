#' Simulated Habitat and Detector Grid
#'
#' Simulated GMRF and detector grid to use in publication.
#'
#' @format ## `sim_1`
#' A list:
#' \describe{
#'   \item{statespace}{Data frame of centroids of cells that make up the state space and their associated habitat.}
#'   \item{detectors}{Data frame of acoustic detector locations.}
#' }
#' @examples
#'\dontrun{
#' set.seed(7263)
